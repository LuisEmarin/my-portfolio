    ...
    return (
        <section id='about'>
            ...
            <div className='conatainer px-5 py-10 mx-auto text-center lg:px-40'>
                <IdentificationIcon  className='mx-auto block w-10 mb-4'/>
                ...
                <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-start ">
                    ...
                    Software Developer with a proven ability to collaborate effectively with senior developers. While spending extra time to be closely mentored and mentor whenever possible. Enjoy working individually or closely with team members to overcome challenges and ensure objectives are met efficiently. With a passion for both personal growth and for software development, I attended a 500+ hour coding bootcamp to learn new languages while sharpening existing skills. Ready to apply my passion for coding to a talented engineering team to thrive as a software developer and further a company's success.
                    </p>
                </div>
            </div>
        </section>
